...
static void H_fetch_T3NS(struct instructionset * const instructions);
...
static void H_fetch_T3NS_su2(struct instructionset * const instructions);
...
{
  if(NN_H_has_su2())
    H_fetch_T3NS_su2(instructions);
  else
    H_fetch_T3NS(instructions);
}
...
static void H_fetch_T3NS_su2(struct instructionset * const instructions)
{
  ...
  instr[12] = 1; instr[13] = 0; instr[14] = 1; pref[4] = 1;
  instr[15] = 1; instr[16] = 2; instr[17] = 3; pref[5] = -t;
  
  instr[18] = 2; instr[19] = 0; instr[20] = 2; pref[6] = 1;
  instr[21] = 2; instr[22] = 1; instr[23] = 3; pref[7] = -t;
