...
double Z2_prefactor_permutation(int (*symv)[3], int permuteType)
{
        ...
        case 2:
                return (symv[0][1] * symv[2][1] + 
                        (symv[0][1] + symv[2][1]) * symv[3][1]) % 2 ? -1 : 1;
        case 3:
                return (symv[0][1] * symv[1][1] +
                        (symv[0][1] + symv[1][1]) * symv[1][0]) % 2 ? -1 : 1;
        case 4:
                return (symv[2][1] * (symv[0][1] + symv[1][1]) +
                        (symv[2][1] + symv[0][1]) * symv[1][0]) % 2 ? -1 : 1;
        case 5:
                return (symv[0][1] * (symv[1][1] + symv[2][1]) +
                        (symv[1][1] + symv[0][1]) * symv[1][0]) % 2 ? -1 : 1;
        default:
