 ...
 * rOperators needed by the passed instructionset
 *
 * **Note**: This function is parallelized through openMP.
 *
 * @param [in] ur The previously made unique rOperators generated by the unique
 * instructions in the instructionset.
 * @param [in] set The instructionset.
 * @return The final set of rOperators.
 */
